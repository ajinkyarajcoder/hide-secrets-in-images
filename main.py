...
def decrypt(key, source, decode=True):
    ...
    def convertToRGB(img):
        try:
            ...
            print("[yellow]Converted image to RGB [/red]- %s")
            return background
...
def encodeImage(image, message, filename):
    with console.status("[green]Encoding image..") as status:
        try:
            ...
            for ch in message:
                ...
                for i in range(0, 8):
                    ...
                    if current_bit == '0':
                        if three_pixels[i] % 2 != 0:
                            three_pixels[
                                i] = three_pixels[i] - 1 if three_pixels[
                                    i] == 255 else three_pixels[i] + 1
                    elif current_bit == '1':
                        if three_pixels[i] % 2 == 0:
                            three_pixels[
                                i] = three_pixels[i] - 1 if three_pixels[
                ...
                if (tmp == len(message)):
                    ...
                    if three_pixels[-1] % 2 == 0:
                        three_pixels[
                            -1] = three_pixels[-1] - 1 if three_pixels[
                                -1] == 255 else three_pixels[-1] + 1
                else:
            ...
            print(
                "[green]Image encoded and saved as [u][bold]%s[/green][/u][/bold]"
                % encoded_filename)
...
def print_credits():
    ...
    table.add_row("AJINKYARAJ", "ajinkyarajjagadale@gmail.com ")
    console.print(table)
...
if __name__ == "__main__":
    ...
    cprint(figlet_format('IMGHIDE!', font='starwars'),
           'yellow',
           attrs=['bold'])
    print_credits()
    print()
